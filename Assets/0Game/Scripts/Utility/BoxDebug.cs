...
public static class BoxDebug
{
	...
	public static void DrawBoxCastOnHit(Vector3 center, Vector3 halfExtents, Vector3 direction, Quaternion orientation, float hitInfoDistance, Color color, float duration)
	{
		center = CastCenterOnCollision(center, direction, hitInfoDistance);
		DrawBox(center, halfExtents, orientation, color, duration);
	}

	//Draws the full box from start of cast to its end distance. Can also pass in hitInfoDistance instead of full distance
	public static void DrawBoxCastBox(Vector3 center, Vector3 halfExtents, Vector3 direction, Quaternion orientation, float maxDistance, Color color, float duration)
	{
		direction.Normalize();
	...
	{
		DrawBox(new Box(center, halfExtents, orientation), color, duration);
	}
